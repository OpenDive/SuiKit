...
public struct RPC_MOVE_STRUCT_FIELDS: SuiKit.SelectionSet, Fragment {
  ...
  public struct Field: SuiKit.SelectionSet {
    ...
    public static var __parentType: ApolloAPI.ParentType { SuiKit.Objects.MoveField }
    public static var __selections: [ApolloAPI.Selection] { [
      .field("__typename", String.self),
      .field("name", String.self),
  ...
  public struct TypeParameter: SuiKit.SelectionSet {
    ...
    public static var __parentType: ApolloAPI.ParentType { SuiKit.Objects.MoveStructTypeParameter }
    public static var __selections: [ApolloAPI.Selection] { [
      .field("__typename", String.self),
