...
public class GetObjectQuery: GraphQLQuery {
  public static let operationName: String = "getObject"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query getObject($id: SuiAddress!, $showBcs: Boolean = false, $showOwner: Boolean = false, $showPreviousTransaction: Boolean = false, $showContent: Boolean = false, $showDisplay: Boolean = false, $showType: Boolean = false, $showStorageRebate: Boolean = false) { object(address: $id) { ...RPC_OBJECT_FIELDS } }"#,
    ...
    public struct Object: SuiKit.SelectionSet {
      ...
      public struct AsMoveObject: SuiKit.SelectionSet {
        ...
        public struct IfShowType: SuiKit.InlineFragment, ApolloAPI.CompositeInlineFragment {
          ...
          public typealias RootEntityType = GetObjectQuery.Data.Object.AsMoveObject
          public static var __parentType: ApolloAPI.ParentType { SuiKit.Objects.MoveObject }
