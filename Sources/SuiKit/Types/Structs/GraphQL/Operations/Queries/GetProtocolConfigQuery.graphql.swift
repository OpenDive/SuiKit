...
public class GetProtocolConfigQuery: GraphQLQuery {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query getProtocolConfig($protocolVersion: Int) { protocolConfig(protocolVersion: $protocolVersion) { __typename protocolVersion configs { __typename key value } featureFlags { __typename key value } } }"#
    ))

  public var protocolVersion: GraphQLNullable<Int>

  public init(protocolVersion: GraphQLNullable<Int>) {
  ...
  public struct Data: SuiKit.SelectionSet {
    ...
    public struct ProtocolConfig: SuiKit.SelectionSet {
      ...
      public struct Config: SuiKit.SelectionSet {
        ...
        public static var __parentType: ApolloAPI.ParentType { SuiKit.Objects.ProtocolConfigAttr }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
      ...
      public struct FeatureFlag: SuiKit.SelectionSet {
        ...
        public static var __parentType: ApolloAPI.ParentType { SuiKit.Objects.ProtocolConfigFeatureFlag }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
          .field("key", String.self),
