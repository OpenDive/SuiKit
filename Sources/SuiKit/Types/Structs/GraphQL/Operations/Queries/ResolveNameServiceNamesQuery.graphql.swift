  ...
  public struct Data: SuiKit.SelectionSet {
    ...
    public struct Address: SuiKit.SelectionSet {
      ...
      public struct SuinsRegistrations: SuiKit.SelectionSet {
        ...
        public static var __parentType: ApolloAPI.ParentType { SuiKit.Objects.SuinsRegistrationConnection }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
        ...
        public struct Node: SuiKit.SelectionSet {
          ...
          public static var __parentType: ApolloAPI.ParentType { SuiKit.Objects.SuinsRegistration }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
