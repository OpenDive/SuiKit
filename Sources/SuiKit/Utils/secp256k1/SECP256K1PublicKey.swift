...
public struct SECP256K1PublicKey: Equatable, PublicKeyProtocol {
    ...
    public func verify(data: Data, signature: Signature) throws -> Bool {
        ...
        guard let _ = resultSignature, resultSignature != 0 else { throw SuiError.notImplemented }
        ...
        guard let _ = pubKeyResult, pubKeyResult != 0 else { throw SuiError.notImplemented }
